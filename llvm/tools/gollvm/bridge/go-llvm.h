...
public:
  ...
  // Inform bridge that we may be using (accurate or inaccurate) AutoFDO.
  void setEnableAutoFDO(bool accurate) {
    autoFDO_ = true;
 ...
 private:
  ...
  // The AutoFDO sampling profile is accurate, allow to mark the call sites
  // without sample as cold.
  bool samplingProfileAccurate_;
};
