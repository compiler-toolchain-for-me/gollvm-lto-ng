...
class Gogo
{
 public:
  ...
  // Get goinstrument flag.
  bool
  goinstrument() const
  {
    return this->goinstrument_;
  }

  // Set goinstrument flag.
  void
  set_goinstrument(bool val)
  {
    this->goinstrument_ = val;
  }
 ...
 private:
  ...
  // Import goinstrument package to be used for writing profiling counters.
  // Enabled by driver for instrumentation with -f[cs-]profile-generate.
  bool goinstrument_;
};
